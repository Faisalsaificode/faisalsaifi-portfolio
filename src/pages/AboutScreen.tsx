  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row items-center gap-6 mt-16 z-10">
        ...
        >
          <motion.a
            href="https://github.com/faisalsaificode"
            target="_blank"
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-xs sm:text-sm md:text-base text-gray-800 leading-relaxed">
                    Skilled full-stack software developer with hands-on experience in building and deploying web applications, including
                    food delivery systems, e-commerce platforms, and airline management solutions using HTML, CSS, JavaScript,
                    Java, and Python. Certified in Data Structures and Algorithms, Microsoft Azure Security (AZ-500), MySQL, and
                    RPA (Automation Anywhere). Proficient in cloud computing, database management, automation, and security.
                    Passionate about building scalable, user-friendly applications while continuously expanding expertise in emerging
                    technologies.
                  </p>
                </div>
              </motion.div>
      ...
      <motion.div
            ...
            >
              ...
              <div className="flex justify-center gap-6">
                ...
                <motion.a
                  href="https://linkedin.com/in/faisaltestlink"
                  whileHover={{ y: -2, scale: 1.1 }}
                  className="p-2 border-2 border-white bg-black bg-opacity-30 rounded"
                >
                ...
                <motion.a
                  href="https://x.com/faisaltestlink"
                  whileHover={{ y: -2, scale: 1.1 }}
                  className="p-2 border-2 border-white bg-black bg-opacity-30 rounded"
                >
