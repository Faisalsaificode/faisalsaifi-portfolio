      ...
      window.cipher = {
        decode: (code: string) => {
          if (code === reversedCode && easterEggStage === 2) {
            ...
            console.log(
              "%c👉 Source Code: https://github.com/faisalsaificode",
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <PixelButton
                onClick={() =>
                  window.open(
                    "https://drive.google.com/file/d/1t5m4Q3QTL4-o1_DB41cUvoJseRyfdS2L/view?usp=drive_link",
                    "_blank"
                  )
                }
                className="px-6 py-3 text-base md:text-lg bg-gray-700/80 text-gray-200 shadow-glow border-2 border-white/20 hover:bg-gray-600/90 transition-all"
